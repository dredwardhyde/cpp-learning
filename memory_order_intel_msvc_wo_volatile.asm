...
PUBLIC	?ptr2@@3PAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@A ; ptr2
PUBLIC	?data@@3HA					; data
_BSS	SEGMENT
?ptr2@@3PAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@A DD 01H DUP (?) ; ptr2
...
$LN2@consumer:
; Line 28
	cmp	DWORD PTR ?ptr2@@3PAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@A, 0 ; ptr2
	jne	SHORT $LN3@consumer
	jmp	SHORT $LN2@consumer
$LN3@consumer:
; Line 29
	push	OFFSET $SG43140
	mov	eax, DWORD PTR ?ptr2@@3PAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@A ; ptr2
	push	eax
...
$LN4@producer:
	...
	mov	DWORD PTR ?ptr2@@3PAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@A, eax ; ptr2
; Line 21
